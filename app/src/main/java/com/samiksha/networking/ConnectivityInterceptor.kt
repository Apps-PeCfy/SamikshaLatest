...
import com.samiksha.SamikshaApplication
...
class ConnectivityInterceptor : Interceptor {
    ...
    private val applicationContext = SamikshaApplication.applicationContext()
    ...
    private fun isInternetAvailable(): Boolean {
        ...
        if (Build.VERSION.SDK_INT < 23) {
            ...
            if (ni != null) {
                return ni.isConnected && (ni.type == ConnectivityManager.TYPE_WIFI || ni.type == ConnectivityManager.TYPE_MOBILE || ni.type == ConnectivityManager.TYPE_ETHERNET)
            }
        } else {
