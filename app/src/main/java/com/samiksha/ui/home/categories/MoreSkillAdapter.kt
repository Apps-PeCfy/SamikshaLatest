...
class MoreSkillAdapter(
    var context: FragmentActivity?,
    var moreCategortArrayList: List<CategoriesResponsePOJO.DataItem>
) : RecyclerView.Adapter<MoreSkillAdapter.PreferencesViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: PreferencesViewHolder, position: Int) {
        ...
        if(model.type.equals("Paid") && model.isSubscription) {
        ...
        if (row_index == position) {
            ...
            iclickListener!!.clickMoreSkill(model)
