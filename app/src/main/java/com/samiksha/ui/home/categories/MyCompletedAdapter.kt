...
class MyCompletedAdapter(
    var context: FragmentActivity?,
    var moreCategortArrayList: List<CategoriesResponsePOJO.DataItem>
) : RecyclerView.Adapter<MyCompletedAdapter.PreferencesViewHolder>() {

    private var myCompleteclickListener: MyCompleteClickListener? = null
    ...
    override fun onBindViewHolder(viewHolder: PreferencesViewHolder, position: Int) {
        val model = moreCategortArrayList[position]
        viewHolder.rlReward.visibility = View.GONE
        ...
        viewHolder.imgFavorites.setOnClickListener {
            myCompleteclickListener!!.onFavoriteClick(model)
        }
        ...
        if (row_index == position) {
            ...
            myCompleteclickListener!!.myCompleteclick(model)
    ...
    override fun getItemCount(): Int {
        return moreCategortArrayList.size
    }
    ...
    inner class PreferencesViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        init {
            ...
            rlReward = itemView.findViewById<View>(R.id.rlReward) as RelativeLayout
    ...
    fun setClickListener(myCompleteclickListener: Homefragment) {
        this.myCompleteclickListener = myCompleteclickListener
    }


    interface MyCompleteClickListener {
        fun myCompleteclick(model : CategoriesResponsePOJO.DataItem)
