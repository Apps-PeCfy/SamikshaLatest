...
import com.samiksha.ui.home.ITrainingPathPresenter
import com.samiksha.ui.home.ITrainingPathView
import com.samiksha.ui.home.TrainingPathImplementer
...
class TrainingPathFragment : Fragment(), AdapterView.OnItemSelectedListener, ITrainingPathView {
    ...
    var iTrainingPathPresenter: ITrainingPathPresenter? = null
    ...
    private fun initFragment() {
        ...
        iTrainingPathPresenter = TrainingPathImplementer(this)
  ...
  */
    ...
    private fun showViewInfo() {
        ...
        txtMental.text = "Training Path"
        txtInfo.text =
            "It is highly recommended to follow 3 mental exercises everyday for 3 months"
    ...
    private fun setRecyclerView() {
            ...
            object : TrainingPathAdapter.TrainingPathAdapterInterface {
                ...
                override fun onRepeatClick(position: Int, model: TrainingPathModel.DataItem) {
                    if (ProjectUtils.checkInternetAvailable(context)!!) {
                        ...
                        showAlertDialog(
                            context?.resources?.getString(R.string.msg_repeat_schedule)!!,
                            model
                        )
        ...
        recyclerView?.addOnScrollListener(object : PaginationScrollListener(layoutManager) {
            override fun loadMoreItems() {
                this@TrainingPathFragment.isLoading = true
                currentPage++
                Handler().postDelayed({ loadNextPage(currentPage) }, 1000)
            }
            ...
            override fun isLastPage(): Boolean {
                return this@TrainingPathFragment.isLastPage
            }

            override fun isLoading(): Boolean {
                return this@TrainingPathFragment.isLoading
            }
        })
    ...
    private fun resetAPI(): Unit {
        ...
        isLastPage = false
        iTrainingPathPresenter?.trainingSkillList(token, startDateForAPI)
    }

    private fun loadNextPage(currentPage: Int) {
        iTrainingPathPresenter?.trainingSkillListNext(token, startDateForAPI,currentPage)
    }
