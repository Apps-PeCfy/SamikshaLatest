...
class TrainingPathImplementerCoach(var view: ITrainingPathView) :
    ITrainingPathPresenterCoach {

    override fun trainingSkillList(token: String?, id:String?,startDate: String?) {
        view.showWait()
        val call = ApiClient.client.getTrainingSkillListWithID("Bearer $token",id, startDate)
